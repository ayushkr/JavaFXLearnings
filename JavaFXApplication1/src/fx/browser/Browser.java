...
import fx.browser.WebViewSample;
import fx.Utils.UrlUtil;
...
public class Browser extends Region {
    ...
    private static String[] urls = new String[]{
        "userFiles/index.html",
        "http://blogs.oracle.com/",
        "http://docs.oracle.com/javase/index.html",
        "userFiles/barsandtone.flv",
        WebViewSample.class.getResource("resources/help.html").toExternalForm()
    };
        ...
        for (int i = 0; i < captions.length; i++) {
            ...
            hpl.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent e) {
                    ...
                    String properUrl = UrlUtil.getProperUrl(url);
                    System.out.println(" Loading "+properUrl);
                    webEngine.load(properUrl);
                }
            });
        }
